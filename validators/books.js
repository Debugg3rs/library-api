...
export const addBookValidator = Joi.object({
  ...
  isbn: Joi.string().pattern(/^[0-9\-]+$/).optional(), // ISBN format validation
  ...
  coverImage: Joi.string().uri().optional(), // Ensure it's a valid URL
  availabilityStatus: Joi.string().valid("Available", "Borrowed", "Reserved", "Lost").default("Available"),
